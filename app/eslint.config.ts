...
export default defineConfig(
  // Global ignores
  // _archive holds retired pages kept in-tree for reference; excluded from the
  // TS build (tsconfig.app.json) and from lint.
  globalIgnores(['.angular/', 'dist/', '**/apps/_archive/']),
