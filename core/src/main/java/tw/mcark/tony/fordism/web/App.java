...
public final class App {
    ...
    public Javalin startOn(int port) {
        ...
        SkillController skillApi = new SkillController(skills, skillPlugins);
        ...
        ApiTokenController apiTokenApi = new ApiTokenController(accounts);
        ...
        // Self-service MFA. Under /api/auth/* so it is reachable by a session alone (the gate does
        // not run here); each handler re-checks the session and the CSRF header itself.
        app.post("/api/auth/mfa/begin", authApi::beginMfa);
        app.post("/api/auth/mfa/confirm", authApi::confirmMfa);
        app.post("/api/auth/mfa/disable", authApi::disableMfa);
        ...
        app.get("/api/skills-file", skillApi::file);
        app.post("/api/skills-delete", skillApi::deleteMany);
        ...
        app.get("/api/audit", groupApi::audit);
        app.get("/api/api-tokens", apiTokenApi::list);
        app.post("/api/api-tokens", apiTokenApi::create);
        app.delete("/api/api-tokens/{id}", apiTokenApi::delete);
        app.start(port);
